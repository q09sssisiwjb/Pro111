...
import { signUpWithEmailAndPassword, signUpWithGoogle } from '@/lib/firebase';
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>Create a new account with username, email and password</CardDescription>
      </CardHeader>
      <CardContent>
